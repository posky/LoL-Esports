...
class Sheet:
    ...
    def write_sheet(
        self, sheet_range, value_range_body, value_input_option="USER_ENTERED"
    ):
        try:
    ...
    def update_sheet(
        ...
        if index:
            ...
            values += [
                value
                for value in df.replace([np.inf, -np.inf], np.nan)
                .fillna("")
                .values.tolist()
            ]
        ...
        self.write_sheet(sheet_range, {"values": values}, value_input_option)
